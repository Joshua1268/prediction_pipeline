...
def run_streamlit_interface():
    """Démarre l'interface Streamlit pour la prédiction locale"""
    print("🚀 Démarrage de l'interface de prédiction locale...")

    # Importer et exécuter l'application Streamlit
    try:
        ...
        bootstrap.run(file=(str(app_path)), command_line="",
                     args=[], flag_options={})
    except ImportError:
...
def deploy_to_cloud():
    """Déploie l'environnement MLOps vers le cloud AWS"""
    # --- Configurations ---
    ...
    print("\n✅ Le déploiement cloud est terminé.")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Pipeline de prédiction - Mode d'exécution")
    parser.add_argument("--mode", choices=["local", "cloud"], default="local",
                       help="Mode d'exécution: local pour l'interface Streamlit, cloud pour déploiement AWS")
